...
public class PushAndResetAndIntakeBlue extends SequentialCommandGroup {
    public PushAndResetAndIntakeBlue(Elevator elevator, Manipulator manipulator, Intake intake) {
        addCommands(
