...
public class Constants {
    ...
    public static class Elevator {
        ...
        public static double ELEVATOR_P_COEFF = 0.0;
        public static double ELEVATOR_I_COEFF = 0.0;
        public static double ELEVATOR_D_COEFF = 0.0;
    ...
    public static class Manipulator {
        ...
        public static class Turret {
            ...
            public static double TURRET_P_COEFF = 0.0;
            public static double TURRET_I_COEFF = 0.0;
            public static double TURRET_D_COEFF = 0.0;
