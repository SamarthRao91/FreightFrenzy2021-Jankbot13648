        ...
        switch (capstonePosition)
        {
            case LEFT:
                addCommands(
                        ...
                        new WaitCommand(250),
                        new FollowTrajectory(drive, Red_Top_Path.RT_trajfix),
                        ...
                        // Cycle #2
                        new FollowTrajectory(drive, Red_Top_Path.RT_traj7).alongWith(new ResetMechanisms(elevator, manipulator)),
                        new InstantCommand(() -> intake.setIntake(1)),
                        ...
                        new InstantCommand(() -> intake.setIntake(-0.66)),
                        new WaitCommand(250),
                        new FollowTrajectory(drive, Red_Top_Path.RT_trajfix2),
                        new FollowTrajectory(drive, Red_Top_Path.RT_traj9).alongWith(new RedHighPreset(elevator, manipulator)),
                        new FollowTrajectory(drive, Red_Top_Path.RT_traj10),
                        new DropGamePiece(elevator, manipulator),

                        // Cycle #3
                        new FollowTrajectory(drive, Red_Top_Path.RT_traj11).alongWith(new ResetMechanisms(elevator, manipulator)),
                        new InstantCommand(() -> intake.setIntake(1)),
