...
public class RedBiasedResetMechanisms extends SequentialCommandGroup {

    public RedBiasedResetMechanisms(Elevator elevator, Manipulator manipulator)
    {
        addCommands(
                ...
                new InstantCommand(() -> manipulator.setTurretPosition(0.56)),
                new WaitCommand(500),
