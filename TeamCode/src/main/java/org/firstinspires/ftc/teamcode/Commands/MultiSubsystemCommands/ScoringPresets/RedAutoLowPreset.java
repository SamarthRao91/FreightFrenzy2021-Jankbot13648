    ...
    public RedAutoLowPreset(Elevator elevator, Manipulator manipulator) {
            ...
            addCommands(
                    new ParallelCommandGroup(
                            new InstantCommand(() -> manipulator.setArm(0.17)),
                            new TurretToPosition(manipulator, Constants.Manipulator.Turret.RIGHT_MAXIMUM_POSITION + 12, 1),
                    ...
                    new WaitCommand(375),
                    new ElevatorToPosition(elevator, 837, 1)
            );
