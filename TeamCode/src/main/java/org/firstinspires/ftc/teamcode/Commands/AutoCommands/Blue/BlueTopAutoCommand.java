...
public class BlueTopAutoCommand extends SequentialCommandGroup {
    ...
    public BlueTopAutoCommand(Drive drive, Elevator elevator, Manipulator manipulator, Intake intake, CapstonePipeline.CapstonePosition capstonePosition, Blue_Top_Path paths)
    {
        switch (capstonePosition)
        {
            case LEFT:
                addCommands(
                        ...
                        new FollowTrajectory(drive, paths.BT_traj1).alongWith(new BlueAutoReverseLowPreset(elevator, manipulator)),
                        new DropGamePiece(elevator, manipulator),

                        // Cycle #1
                        new InstantCommand(() -> intake.setIntake(1)),
                        new FollowTrajectory(drive, paths.BT_traj2).alongWith(new ResetMechanisms(elevator, manipulator)),
                        ...
                        new WaitCommand(250),
                        new FollowTrajectory(drive, paths.BT_traj3).alongWith(new BlueHighPreset(elevator, manipulator)),
                        new DropGamePiece(elevator, manipulator),

                        // Cycle #2
                        new InstantCommand(() -> intake.setIntake(1)),
                        new FollowTrajectory(drive, paths.BT_traj4).alongWith(new ResetMechanisms(elevator, manipulator)),
                        new InstantCommand(() -> manipulator.setClawPosition(Constants.Manipulator.Claw.CLOSE_POSITION)),
                        new WaitCommand(250),
                        new InstantCommand(() -> intake.setIntake(-0.66)),
                        new WaitCommand(250),
                        new FollowTrajectory(drive, paths.BT_traj5).alongWith(new BlueHighPreset(elevator, manipulator)),
                        new DropGamePiece(elevator, manipulator),

                        // Cycle #3
                        new InstantCommand(() -> intake.setIntake(1)),
                        new FollowTrajectory(drive, paths.BT_traj6).alongWith(new ResetMechanisms(elevator, manipulator)),
                        new InstantCommand(() -> manipulator.setClawPosition(Constants.Manipulator.Claw.CLOSE_POSITION)),
                        new WaitCommand(250),
                        new InstantCommand(() -> intake.setIntake(-0.66)),
                        new WaitCommand(250),
                        new FollowTrajectory(drive, paths.BT_traj7)/*,
                        new FollowTrajectory(drive, paths.BT_traj14),
            ...
            case CENTER:
                addCommands(
                        new InstantCommand(() -> drive.setPoseEstimate(new Pose2d(0,0, Math.toRadians(0)))),
                        new FollowTrajectory(drive, paths.BT_traj1).alongWith(new BlueAutoReverseMiddlePreset(elevator, manipulator)),
                        new DropGamePiece(elevator, manipulator),
            ...
            case RIGHT:
                addCommands(
                        new InstantCommand(() -> drive.setPoseEstimate(new Pose2d(0,0, Math.toRadians(0)))),
                        new FollowTrajectory(drive, paths.BT_traj1).alongWith(new BlueHighPreset(elevator, manipulator)),
                        new DropGamePiece(elevator, manipulator),
