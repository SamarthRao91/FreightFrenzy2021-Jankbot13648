        ...
        switch (capstonePosition)
        {
            case LEFT:
                addCommands(
                        ...
                        new WaitCommand(250),
                        new FollowTrajectory(drive, Blue_Top_Path.BT_trajfix),
                        new FollowTrajectory(drive, Blue_Top_Path.BT_traj5).alongWith(new BlueHighPreset(elevator, manipulator)),
                        new FollowTrajectory(drive, Blue_Top_Path.BT_traj6),
                        new DropGamePiece(elevator, manipulator),

                        // Cycle #2
                        new FollowTrajectory(drive, Blue_Top_Path.BT_traj7).alongWith(new ResetMechanisms(elevator, manipulator)),
                        new InstantCommand(() -> intake.setIntake(1)),
                        new FollowTrajectory(drive, Blue_Top_Path.BT_traj8),
                        new InstantCommand(() -> manipulator.setClawPosition(Constants.Manipulator.Claw.CLOSE_POSITION)),
                        new WaitCommand(250),
                        new InstantCommand(() -> intake.setIntake(-0.66)),
                        new WaitCommand(250),
                        new FollowTrajectory(drive, Blue_Top_Path.BT_trajfix2),
                        new FollowTrajectory(drive, Blue_Top_Path.BT_traj9).alongWith(new BlueHighPreset(elevator, manipulator)),
                        new FollowTrajectory(drive, Blue_Top_Path.BT_traj10),
                        new DropGamePiece(elevator, manipulator),

                        // Cycle #3
                        new FollowTrajectory(drive, Blue_Top_Path.BT_traj11).alongWith(new ResetMechanisms(elevator, manipulator)),
                        new InstantCommand(() -> intake.setIntake(1)),
                        ...
                        new InstantCommand(() -> intake.setIntake(-0.66)),
                        new WaitCommand(250),
                        new FollowTrajectory(drive, Blue_Top_Path.BT_traj13)/*,
