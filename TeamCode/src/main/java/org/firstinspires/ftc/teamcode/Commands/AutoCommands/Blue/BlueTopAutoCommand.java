        ...
        switch (capstonePosition) {
            case LEFT:
                addCommands(
                        ...
                        new FollowTrajectory(drive, Blue_Top_Path.BT_traj3),
                        ...
                        new BlueHighPreset(elevator, manipulator).alongWith(new FollowTrajectory(drive, Blue_Top_Path.BT_traj4)),
                        new DropGamePiece(elevator, manipulator),
                        new InstantCommand(() -> intake.setIntake(1)),
                        new BlueBiasedResetMechanisms(elevator, manipulator).alongWith(new FollowTrajectory(drive, Blue_Top_Path.BT_traj5)),
