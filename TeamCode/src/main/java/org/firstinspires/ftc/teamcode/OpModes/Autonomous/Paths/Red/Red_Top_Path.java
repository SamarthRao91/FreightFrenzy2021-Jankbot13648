...
public class Red_Top_Path {
    ...
    //back out
    public static Trajectory RT_trajfix = BuildTrajectory(RT_traj4.end())
            .lineTo(new Vector2d(18, -3.5),
                    MecanumDrive.getVelocityConstraint(AUTO_MAX_VEL, Math.toRadians(60), TRACK_WIDTH),
                    MecanumDrive.getAccelerationConstraint(AUTO_MAX_ACCEL))
            .build();

    public static Trajectory RT_traj5 = BuildTrajectory(RT_trajfix.end())
    ...
    public static Trajectory RT_trajfix2 = BuildTrajectory(RT_traj8.end())
            .lineTo(new Vector2d(18, -6),
                    MecanumDrive.getVelocityConstraint(AUTO_MAX_VEL, Math.toRadians(60), TRACK_WIDTH),
                    MecanumDrive.getAccelerationConstraint(AUTO_MAX_ACCEL))
            .build();
    public static Trajectory RT_traj9 = BuildTrajectory(RT_trajfix2.end())
